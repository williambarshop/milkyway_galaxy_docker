...
RUN echo '06-24-2017' && git clone https://github.com/wohllab/milkyway_proteomics.git --branch master
...
RUN . "$GALAXY_VIRTUAL_ENV/bin/activate" && easy_install pyopenms && pip install uniprot_tools h5py ephemeris futures tqdm joblib multiprocessing pandas argparse pymzml pyteomics==3.2 natsort tqdm biopython lxml Orange-Bioinformatics -U
